...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Drama-Interactive-Script", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Drama-Interactive-Script", null, 1366, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "277";
		app.meta["company"] = "[A2]";
		app.meta["file"] = "Drama-Interactive-Script";
		app.meta["name"] = "Drama Interactive Script";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Drama Interactive Script",
			width: 1366,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Drama Interactive Script";
		#else
		app.window.context.attributes.background = 6316128;
