...
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_metropolis_otf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/metropolis.otf"; name = "Metropolis Bold"; super (); }}


#else

@:keep @:expose('__ASSET__assets_fonts_metropolis_otf') @:noCompletion #if display private #end class __ASSET__assets_fonts_metropolis_otf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/metropolis.otf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Metropolis Bold"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_fonts_metropolis_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_metropolis_otf extends openfl.text.Font { public function new () { name = "Metropolis Bold"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__assets_fonts_metropolis_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_metropolis_otf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/metropolis.otf"; name = "Metropolis Bold"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
