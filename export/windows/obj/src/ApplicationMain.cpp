...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Drama-Interactive-Script",5c,99,1a,81),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("277",d2,20,26,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("[A2]",f1,e8,57,3c));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Drama-Interactive-Script",5c,99,1a,81));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Drama Interactive Script",42,8a,d9,22));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),1366)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Drama Interactive Script",42,8a,d9,22))
...
HXLINE(  69)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),6316128)
