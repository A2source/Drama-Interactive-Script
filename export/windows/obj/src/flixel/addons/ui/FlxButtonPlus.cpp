...
HXLINE( 106)		{
HXLINE( 106)			 ::flixel::addons::display::FlxExtendedMouseSprite Value =  ::flixel::addons::display::FlxExtendedMouseSprite_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE( 119)		{
HXLINE( 119)			 ::flixel::addons::display::FlxExtendedMouseSprite Value1 =  ::flixel::addons::display::FlxExtendedMouseSprite_obj::__alloc( HX_CTX ,null(),null(),null());
...
HXLINE( 160)		 ::flixel::addons::display::FlxExtendedMouseSprite _hx_tmp = this->buttonNormal;
HXDLIN( 160)		_hx_tmp->set_pixels(Normal->get_pixels());
HXLINE( 161)		 ::flixel::addons::display::FlxExtendedMouseSprite _hx_tmp1 = this->buttonHighlight;
...
HXDLIN( 201)				_g = (_g + 1);
HXLINE( 203)				 ::flixel::addons::display::FlxExtendedMouseSprite _this = this->buttonNormal;
...
HXLINE( 273)		{
HXLINE( 273)			 ::flixel::addons::display::FlxExtendedMouseSprite Value = ( ( ::flixel::addons::display::FlxExtendedMouseSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->buttonNormal)) );
...
HXLINE( 274)		{
HXLINE( 274)			 ::flixel::addons::display::FlxExtendedMouseSprite Value1 = ( ( ::flixel::addons::display::FlxExtendedMouseSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->buttonHighlight)) );
...
HXLINE( 331)		 ::flixel::addons::display::FlxExtendedMouseSprite _hx_tmp = this->buttonNormal;
...
HXLINE( 370)		 ::flixel::addons::display::FlxExtendedMouseSprite _hx_tmp = this->buttonHighlight;
...
HX_DEFINE_DYNAMIC_FUNC1(FlxButtonPlus_obj,set_text,return )
 ...
 ::flixel::addons::display::FlxExtendedMouseSprite FlxButtonPlus_obj::set_buttonNormal( ::flixel::addons::display::FlxExtendedMouseSprite Value){
...
HX_DEFINE_DYNAMIC_FUNC1(FlxButtonPlus_obj,set_buttonNormal,return )
 ...
 ::flixel::addons::display::FlxExtendedMouseSprite FlxButtonPlus_obj::set_buttonHighlight( ::flixel::addons::display::FlxExtendedMouseSprite Value){
...
::hx::Val FlxButtonPlus_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"buttonNormal") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_buttonNormal(inValue.Cast<  ::flixel::addons::display::FlxExtendedMouseSprite >()) );buttonNormal=inValue.Cast<  ::flixel::addons::display::FlxExtendedMouseSprite >(); return inValue; }
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"buttonHighlight") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_buttonHighlight(inValue.Cast<  ::flixel::addons::display::FlxExtendedMouseSprite >()) );buttonHighlight=inValue.Cast<  ::flixel::addons::display::FlxExtendedMouseSprite >(); return inValue; }
	}
...
static ::hx::StorageInfo FlxButtonPlus_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::addons::display::FlxExtendedMouseSprite */ ,(int)offsetof(FlxButtonPlus_obj,buttonNormal),HX_("buttonNormal",b9,49,27,d8)},
	{::hx::fsObject /*  ::flixel::addons::display::FlxExtendedMouseSprite */ ,(int)offsetof(FlxButtonPlus_obj,buttonHighlight),HX_("buttonHighlight",e2,05,c4,76)},
