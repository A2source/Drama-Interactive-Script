...
HX_DEFINE_STACK_FRAME(_hx_pos_1b8de2909b3ba780_17_new,"flixel.FlxState","new",0x7e613e23,"flixel.FlxState.new","flixel/FlxState.hx",17,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_93_create,"flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",93,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_96_draw,"flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",96,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_105_openSubState,"flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",105,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_115_closeSubState,"flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",115,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_122_resetSubState,"flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",122,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_160_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",160,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_181_switchTo,"flixel.FlxState","switchTo",0x5e95c7ec,"flixel.FlxState.switchTo","flixel/FlxState.hx",181,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_195_startOutro,"flixel.FlxState","startOutro",0x6cd6bca6,"flixel.FlxState.startOutro","flixel/FlxState.hx",195,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_202_onFocusLost,"flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",202,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_208_onFocus,"flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",208,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_216_onResize,"flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",216,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_220_tryUpdate,"flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",220,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_238_get_bgColor,"flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",238,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_244_set_bgColor,"flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",244,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_249_get_subStateOpened,"flixel.FlxState","get_subStateOpened",0x2fcc7460,"flixel.FlxState.get_subStateOpened","flixel/FlxState.hx",249,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_258_get_subStateClosed,"flixel.FlxState","get_subStateClosed",0x1c89bb63,"flixel.FlxState.get_subStateClosed","flixel/FlxState.hx",258,0xdf96844c)
namespace flixel{

void FlxState_obj::__construct( ::Dynamic MaxSize){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_17_new)
HXLINE(  64)		this->_requestSubStateReset = false;
HXLINE(  42)		this->destroySubStates = true;
HXLINE(  36)		this->persistentDraw = true;
HXLINE(  25)		this->persistentUpdate = false;
...
void FlxState_obj::create(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_93_create)
            	}
...
void FlxState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_96_draw)
HXLINE(  97)		bool _hx_tmp;
HXDLIN(  97)		if (!(this->persistentDraw)) {
HXLINE(  97)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
...
HXLINE( 100)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 101)			this->subState->draw();
            		}
            	}


void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_105_openSubState)
HXLINE( 106)		this->_requestSubStateReset = true;
HXLINE( 107)		this->_requestedSubState = SubState;
            	}
...
void FlxState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_115_closeSubState)
HXDLIN( 115)		this->_requestSubStateReset = true;
            	}
...
void FlxState_obj::resetSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_122_resetSubState)
HXLINE( 124)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 126)			if (::hx::IsNotNull( this->subState->closeCallback )) {
HXLINE( 127)				this->subState->closeCallback();
            			}
HXLINE( 128)			if (::hx::IsNotNull( this->_subStateClosed )) {
HXLINE( 129)				this->_subStateClosed->dispatch(this->subState);
            			}
HXLINE( 131)			if (this->destroySubStates) {
HXLINE( 132)				this->subState->destroy();
            			}
            		}
HXLINE( 136)		this->subState = this->_requestedSubState;
HXLINE( 137)		this->_requestedSubState = null();
HXLINE( 139)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 142)			if (!(this->persistentUpdate)) {
HXLINE( 143)				::flixel::FlxG_obj::inputs->onStateSwitch();
            			}
HXLINE( 145)			this->subState->_parentState = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 147)			if (!(this->subState->_created)) {
HXLINE( 149)				this->subState->_created = true;
HXLINE( 150)				this->subState->create();
            			}
HXLINE( 152)			if (::hx::IsNotNull( this->subState->openCallback )) {
HXLINE( 153)				this->subState->openCallback();
            			}
HXLINE( 154)			if (::hx::IsNotNull( this->_subStateOpened )) {
HXLINE( 155)				this->_subStateOpened->dispatch(this->subState);
            			}
            		}
            	}
...
void FlxState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_160_destroy)
HXLINE( 161)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateOpened);
HXLINE( 162)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateClosed);
HXLINE( 164)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 166)			this->subState->destroy();
HXLINE( 167)			this->subState = null();
            		}
...
bool FlxState_obj::switchTo( ::flixel::FlxState nextState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_181_switchTo)
...
void FlxState_obj::startOutro( ::Dynamic onOutroComplete){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_195_startOutro)
HXDLIN( 195)		onOutroComplete();
            	}
...
void FlxState_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_202_onFocusLost)
            	}
...
void FlxState_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_208_onFocus)
            	}
...
void FlxState_obj::onResize(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_216_onResize)
            	}
...
void FlxState_obj::tryUpdate(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_220_tryUpdate)
HXLINE( 221)		bool _hx_tmp;
HXDLIN( 221)		if (!(this->persistentUpdate)) {
HXLINE( 221)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 221)			_hx_tmp = true;
            		}
HXDLIN( 221)		if (_hx_tmp) {
HXLINE( 222)			this->update(elapsed);
            		}
HXLINE( 224)		if (this->_requestSubStateReset) {
HXLINE( 226)			this->_requestSubStateReset = false;
HXLINE( 227)			this->resetSubState();
            		}
HXLINE( 229)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 231)			this->subState->tryUpdate(elapsed);
            		}
            	}
...
int FlxState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_238_get_bgColor)
HXDLIN( 238)		return ::flixel::FlxG_obj::cameras->get_bgColor();
            	}
...
int FlxState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_244_set_bgColor)
HXDLIN( 244)		return ::flixel::FlxG_obj::cameras->set_bgColor(Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxState_obj,set_bgColor,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateOpened(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_249_get_subStateOpened)
HXLINE( 250)		if (::hx::IsNull( this->_subStateOpened )) {
HXLINE( 251)			this->_subStateOpened =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 253)		return this->_subStateOpened;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,get_subStateOpened,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateClosed(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_258_get_subStateClosed)
HXLINE( 259)		if (::hx::IsNull( this->_subStateClosed )) {
HXLINE( 260)			this->_subStateClosed =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 262)		return this->_subStateClosed;
            	}
