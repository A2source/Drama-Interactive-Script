...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1252_drawDebug,"flixel.FlxObject","drawDebug",0x2ad45ea0,"flixel.FlxObject.drawDebug","flixel/FlxObject.hx",1252,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1272_drawDebugOnCamera,"flixel.FlxObject","drawDebugOnCamera",0x0b2ef7e4,"flixel.FlxObject.drawDebugOnCamera","flixel/FlxObject.hx",1272,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1283_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1283,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1305_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1305,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1318_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1318,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1386_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1386,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1400_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1400,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1484_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1484,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1490_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1490,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1496_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1496,0xf0fe0d80)
...
HXLINE( 774)		this->ignoreDrawDebug = false;
HXLINE( 768)		this->debugBoundingBoxColorPartial = -16744448;
HXLINE( 760)		this->debugBoundingBoxColorNotSolid = -16776961;
HXLINE( 754)		this->debugBoundingBoxColorSolid = -65536;
HXLINE( 748)		this->debugBoundingBoxColor = null();
...
HXLINE( 866)		this->super::update(elapsed);
HXLINE( 869)		{
...
HXLINE( 913)		this->super::draw();
HXLINE( 914)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 915)			this->drawDebug();
            		}
            	}
...
HXLINE( 937)				return ( (bool)(_g(objectOrGroup,x,y,inScreenSpace1,camera1)) );
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE( 937)			 ::Dynamic _g = this->overlapsCallback_dyn();
...
HXDLIN( 937)			return group->any( ::Dynamic(new _hx_Closure_0(y,x,_g,inScreenSpace1,camera1)));
            		}
...
HXLINE( 996)				return ( (bool)(_g(objectOrGroup,x1,y1,inScreenSpace1,camera1)) );
            			}
            			HX_END_LOCAL_FUNC1(return)

HXLINE( 996)			 ::Dynamic _g = this->overlapsAtCallback_dyn();
...
void FlxObject_obj::drawDebug(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1252_drawDebug)
HXLINE(1253)		if (this->ignoreDrawDebug) {
HXLINE(1254)			return;
            		}
HXLINE(1256)		{
HXLINE(1256)			int _g = 0;
HXDLIN(1256)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(1256)			while((_g < _g1->length)){
HXLINE(1256)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1256)				_g = (_g + 1);
HXLINE(1258)				this->drawDebugOnCamera(camera);
HXLINE(1260)				bool _hx_tmp;
HXDLIN(1260)				if (::hx::IsNotNull( this->path )) {
HXLINE(1260)					_hx_tmp = !(this->path->ignoreDrawDebug);
            				}
            				else {
HXLINE(1260)					_hx_tmp = false;
            				}
HXDLIN(1260)				if (_hx_tmp) {
HXLINE(1261)					this->path->drawDebug(null());
            				}
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugOnCamera( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1272_drawDebugOnCamera)
HXLINE(1273)		bool _hx_tmp;
HXDLIN(1273)		bool _hx_tmp1;
HXDLIN(1273)		if (camera->visible) {
HXLINE(1273)			_hx_tmp1 = !(camera->exists);
            		}
            		else {
HXLINE(1273)			_hx_tmp1 = true;
            		}
HXDLIN(1273)		if (!(_hx_tmp1)) {
HXLINE(1273)			_hx_tmp = !(this->isOnScreen(camera));
            		}
            		else {
...
HXLINE(1276)		 ::flixel::math::FlxRect rect = this->getBoundingBox(camera);
HXLINE(1277)		 ::openfl::display::Graphics gfx;
HXDLIN(1277)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1277)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXDLIN(1277)			gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1277)			gfx = camera->debugLayer->get_graphics();
            		}
HXLINE(1278)		this->drawDebugBoundingBox(gfx,rect,this->allowCollisions,this->immovable);
HXLINE(1279)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1279)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
void FlxObject_obj::drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1283_drawDebugBoundingBox)
HXLINE(1285)		 ::Dynamic color = this->debugBoundingBoxColor;
HXLINE(1286)		if (::hx::IsNull( color )) {
HXLINE(1288)			if ((allowCollisions != 0)) {
HXLINE(1290)				if (partial) {
HXLINE(1290)					color = this->debugBoundingBoxColorPartial;
            				}
            				else {
HXLINE(1290)					color = this->debugBoundingBoxColorSolid;
            				}
            			}
            			else {
HXLINE(1294)				color = this->debugBoundingBoxColorNotSolid;
            			}
            		}
HXLINE(1299)		gfx->lineStyle(1,color,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(1300)		gfx->drawRect(rect->x,rect->y,rect->width,rect->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::openfl::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1305_beginDrawDebug)
HXDLIN(1305)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1307)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXLINE(1308)			return ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1312)			return camera->debugLayer->get_graphics();
            		}
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1318_endDrawDebug)
HXDLIN(1318)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1319)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
Float FlxObject_obj::set_width(Float value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1386_set_width)
HXLINE(1388)		if ((value < 0)) {
HXLINE(1390)			::flixel::FlxG_obj::log->advanced(HX_("An object's width cannot be smaller than 0. Use offset for sprites to control the hitbox position!",f5,8d,0b,95),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1391)			return value;
            		}
HXLINE(1395)		return (this->width = value);
            	}
...
Float FlxObject_obj::set_height(Float value){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1400_set_height)
HXLINE(1402)		if ((value < 0)) {
HXLINE(1404)			::flixel::FlxG_obj::log->advanced(HX_("An object's height cannot be smaller than 0. Use offset for sprites to control the hitbox position!",b0,49,90,e4),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1405)			return value;
            		}
HXLINE(1409)		return (this->height = value);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1484_set_debugBoundingBoxColorSolid)
HXDLIN(1484)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1490_set_debugBoundingBoxColorNotSolid)
HXDLIN(1490)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1496_set_debugBoundingBoxColorPartial)
HXDLIN(1496)		return (this->debugBoundingBoxColorPartial = color);
            	}
