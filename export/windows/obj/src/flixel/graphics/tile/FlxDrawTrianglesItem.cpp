...
HXLINE(  92)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE(  94)			 ::openfl::display::Graphics gfx = camera->debugLayer->get_graphics();
HXLINE(  95)			gfx->lineStyle(1,-16776961,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(  96)			gfx->drawTriangles(this->vertices,this->indices,this->uvtData,null());
            		}
