...
::states::ScriptState_obj::__register();
...
::states::BaseState_obj::__register();
...
::openfl::display::Debug_obj::__register();
...
::objects::Tab_obj::__register();
::objects::Script_obj::__register();
::objects::Ribbon_obj::__register();
::objects::QuickObjects_obj::__register();
...
::backend::Display_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_metropolis_otf_obj::__register();
::__ASSET__assets_fonts_metropolis_otf_obj::__register();
