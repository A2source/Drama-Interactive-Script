...
HX_DEFINE_STACK_FRAME(_hx_pos_cc9ea02fe2e2085e_346_new,"__ASSET__flixel_images_transitions_square_png","new",0x4d3675ae,"__ASSET__flixel_images_transitions_square_png.new","lime/_internal/macros/AssetsMacro.hx",346,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_6fdfef3dd188d16d_122_boot,"__ASSET__flixel_images_transitions_square_png","boot",0x3a898324,"__ASSET__flixel_images_transitions_square_png.boot","ManifestResources.hx",122,0xf77aa668)
...
void __ASSET__flixel_images_transitions_square_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_cc9ea02fe2e2085e_346_new)
HXLINE( 375)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 377)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_transitions_square_png_obj::resourceName),null());
            	}
...
bool __ASSET__flixel_images_transitions_square_png_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
...
bool __ASSET__flixel_images_transitions_square_png_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
...
void __ASSET__flixel_images_transitions_square_png_obj::__register()
{
	...
	__mClass->mGetStaticField = &__ASSET__flixel_images_transitions_square_png_obj::__GetStatic;
	__mClass->mSetStaticField = &__ASSET__flixel_images_transitions_square_png_obj::__SetStatic;
...
{
{
            	HX_STACKFRAME(&_hx_pos_6fdfef3dd188d16d_122_boot)
HXDLIN( 122)		resourceName = HX_("__ASSET__:image___ASSET__flixel_images_transitions_square_png",6e,55,71,54);
            	}
}
